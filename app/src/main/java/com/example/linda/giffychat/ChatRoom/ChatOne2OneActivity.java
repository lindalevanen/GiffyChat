 ...
 * (TODO: and later possibly also by searching for a user)
 */
...
public class ChatOne2OneActivity extends ChatActivity {
    ...
    /**
     * Fetches the Chat data from db and after that calls the chat-initialization methods.
     * //TODO: i don't feel confortable the paths always being hardcoded, change this.
     */
    ...
    /**
     * Get "player id" from userData. It has been set if the partner has opened a recent version of this app.
     * Player id is a unique-userid generated by OneSignal-notification service, that is used when sending
     * a user-to-user-notification.
     * @param FBUserID the firebase user id with what to fetch the player id
     */
    ...
    public void sendNotification(String message, boolean isGif) {
        if(Constants.partnerPlayerID != null) {
            ...
            try {
                ...
                if(isGif) messageContent = sender + " has sent you a gif!";
                else      messageContent = sender + ": "+ message;
